      ...
      <main className="mx-auto max-w-6xl px-4 py-16 md:py-24">
        <div className="max-w-3xl">
          <span className="inline-block rounded-full bg-accent/20 px-3 py-1 text-xs font-medium text-accent-foreground">
            Automobile RTO Consultancy
          </span>
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-foreground md:text-6xl">
            Invoicing built for RTO consultants.
          </h1>
          <p className="mt-4 text-lg text-muted-foreground md:text-xl">
            Generate GST-ready invoices from your own Word template, track
            payments, and manage dealers and customers from one place.
          </p>
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-4">
          {[
            ...
            { icon: Users, title: "Dealer & customer", body: "Full CRUD with GSTIN, vehicle details, and contact info." },
